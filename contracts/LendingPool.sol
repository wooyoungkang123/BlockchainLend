...
contract LendingPool is ReentrancyGuard, Ownable {
    ...
    event Liquidated(
        address indexed borrower, address indexed liquidator, uint256 amount, uint256 collateralLiquidated
    );
    ...
    function getUserAccountData(address _user)
        external
        view
        returns (uint256 depositBalance, uint256 borrowBalance, uint256 healthFactor, uint256 ethUsdPrice)
    {
