...
contract LendingPool is ILendingPool, ReentrancyGuard, Ownable {
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        require(
            borrowValue == 0 || (newCollateralValue * LIQUIDATION_THRESHOLD / 100) >= borrowValue,
    ...
    function liquidate(address borrower, uint256 amount) external nonReentrant {
        ...
        require((collateralValue * LIQUIDATION_THRESHOLD / 100) < borrowValue, "LendingPool: position not liquidatable");
