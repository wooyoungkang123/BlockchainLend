...
contract SimplifiedLending {
    ...
    function borrow(uint256 amount) external {
        ...
        require(tokenBalances[address(this)] >= amount, "Insufficient tokens in pool");
    ...
    function repay(uint256 amount) external {
        ...
        tokenBalances[msg.sender] -= repayAmount;
        tokenBalances[address(this)] += repayAmount;
